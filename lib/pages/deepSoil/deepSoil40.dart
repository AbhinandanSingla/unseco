...
import 'package:unseco/pages/deepSoil/deepSoil50.dart';

import 'deepsoil10.dart';

class DeepSoilMoisture40 extends StatefulWidget {
  @override
  State<DeepSoilMoisture40> createState() => _DeepSoilMoisture10State();
}

class _DeepSoilMoisture10State extends State<DeepSoilMoisture40> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          title: Text(AppLocalizations.of(context)!.selectSoil("45"),
              ...
              child: Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          AppLocalizations.of(context)!.selectSoil("45"),
